...
public class IntegerToEnglishWords {
    ...
    public static class LocalizedNumberConverter {
        ...
        public enum Locale {
            US_ENGLISH(ONES, TENS, THOUSANDS, "Zero", "Hundred"),
            UK_ENGLISH(ONES, TENS, new String[]{"", "Thousand", "Million", "Milliard"}, "Zero", "Hundred"),
            // Could extend to other languages
        }
        ...
        public String convert(int num) {
            // Implementation would use locale-specific rules
        ...
        // Locale-specific data (simplified structure)
        static {
            US_ENGLISH.ones = ONES;
            US_ENGLISH.tens = TENS;
            US_ENGLISH.scales = THOUSANDS;
            US_ENGLISH.zero = "Zero";
            US_ENGLISH.hundred = "Hundred";
        }
    }
